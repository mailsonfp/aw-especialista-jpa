...
public class EcmMachineMultiTenantConnectionProvider implements MultiTenantConnectionProvider, ServiceRegistryAwareService, Startable {
	...
	public void start() {
		...
		configurarTenant("algaworks_ecommerce", "jdbc:mysql://localhost/algaworks_ecommerce?"
				+ "createDatabaseIfNotExist=true&useTimezone=true&serverTimezone=UTC", "root", "1234");
